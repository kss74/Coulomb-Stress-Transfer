...
|---|---|---|---|
| `okada_wrapper` | Compiled Fortran DC3D subroutine (Okada 1992) for exact depth-dependent stress/displacement; installed as a pip dependency, not vendored in this repo | [github.com/cutde-org/okada_wrapper](https://github.com/cutde-org/okada_wrapper) | MIT (verify against the package's current `LICENSE` before redistributing) |
...
| `coulomb.mlapp` / Coulomb ver. 4.x (Yoshizawa, Toda, Stein, Sevilgen, Lin) | `coulomb.m` (this project file, extracted from `coulomb.mlapp`) is the actual Coulomb 4.x application source, used locally as the ground-truth benchmark in [Validation](#validation) | [github.com/YoshKae/Coulomb_ver4](https://github.com/YoshKae/Coulomb_ver4) | 
...
```
Copyright (C) 2026  Keanu Jershon Sarmiento
